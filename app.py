...
def load_llm(model_name: str, temperature: float) -> Union[ChatOpenAI, LlamaCpp]:
    ...
    if model_name.startswith("gpt-"):
        ...
        return LlamaCpp(
            ...
            # model_path="/Users/leo/Documents/code/UI/streamlit/models/llama-2-7b-chat.ggmlv3.q3_K_S.bin",
            # model_path="/Users/leo/Documents/code/UI/streamlit/models/ggjt-model.bin",
            # model_path="/Users/leo/Documents/code/UI/streamlit/models/llama-2-13b.Q5_K_M.gguf",
            # "llama-2-13b.Q5_K_M"
...
def load_embeddings(model_name: str) -> Union[OpenAIEmbeddings, LlamaCppEmbeddings]:
    ...
    if model_name.startswith("gpt-"):
        ...
        return LlamaCppEmbeddings(model_path=f"./models/{model_name}.gguf")
...
def get_answer(llm, messages) -> tuple[str, float]:
    ...
    """
    lc_message = convert_langchainschema_to_dict(messages)
    llama_v2_prompt_message = llama_v2_prompt(lc_message)
    return llm(llama_v2_prompt_message), 0.0
